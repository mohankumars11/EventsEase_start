      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
        <Reveal>
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-sm leading-7 text-slate-300 sm:text-base">On event day, movement becomes part of the experience. Sumramo connects the supply side, the route and the venue handoff into one operational story.</p>
          </div>
        </Reveal>
              ...
              <div className="max-w-3xl">
                ...
                <div className="relative mt-7 max-w-2xl">
                  <div className="flex items-center gap-3 rounded-2xl bg-white p-2 shadow-2xl">
                    ...
                    <input value={query} onChange={e => setQuery(e.target.value)} placeholder="Search weddings, catering, decor, logistics…" className="min-w-0 flex-1 bg-transparent px-1 py-3 text-sm text-slate-900 outline-none placeholder:text-slate-400" aria-label="Search Sumramo"/>
