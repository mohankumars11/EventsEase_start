  ...
  'Photography': [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'booth_360', label: '360 degree booth' },
        { id: 'backdrop',  label: 'Backdrops and props' },
        { id: 'live_feed', label: 'Live feed to the venue screens' },
      ],
    },
    {
      id: 'delivery',
  ...
  'Cake & Desserts': [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'cream',    label: 'Fresh cream and whipped' },
        { id: 'photo',    label: 'Photo print cakes' },
        { id: 'cupcakes', label: 'Cupcakes and jar desserts' },
        { id: 'brownie',  label: 'Brownies and bakes' },
  ...
  'DJ & Music': [
    {
      ...
      choices: [
        ...
        /* "Kannada and regional" made four languages into one tick, and
           a family wanting a Tamil floor could not ask for it. */
        { id: 'tamil',     label: 'Tamil' },
        { id: 'telugu',    label: 'Telugu' },
        { id: 'malayalam', label: 'Malayalam' },
        { id: 'bollywood', label: 'Bollywood and commercial' },
        { id: 'punjabi',   label: 'Punjabi and bhangra' },
        { id: 'edm',       label: 'EDM and house' },
        { id: 'retro',     label: 'Retro' },
        { id: 'sufi',      label: 'Sufi and ghazal' },
        { id: 'devotional',label: 'Devotional' },
        { id: 'english',   label: 'English pop and hip hop' },
      ],
    },
    {
      id: 'rig',
  ...
  'Event Lighting': [
    {
      ...
      choices: [
        ...
        { id: 'festoon',  label: 'Festoon and pixel strings' },
        { id: 'par',      label: 'LED par cans' },
        { id: 'uplight',  label: 'Wall uplighters' },
        { id: 'moving',   label: 'Moving heads' },
        { id: 'follow',   label: 'Follow spot', scan: 'For the entry' },
        { id: 'laser',    label: 'Lasers' },
        { id: 'dancefloor', label: 'LED dance floor' },
        { id: 'effects',  label: 'Cold pyro and fog' },
        { id: 'outdoor',  label: 'Outdoor floodlights' },
        { id: 'power',    label: 'We bring our own power',
          scan: 'A lighting rig a venue cannot feed is a dark hall' },
      ],
    },
  ],
  ...
  'Security Services': [
    {
      ...
      choices: [
        ...
        { id: 'women',    label: 'Women security staff',
          scan: 'For frisking and the ladies side' },
        { id: 'detector', label: 'Metal detectors and bag check' },
        { id: 'cctv',     label: 'Temporary CCTV' },
        { id: 'vip',      label: 'Close protection for a VIP guest' },
        { id: 'night',    label: 'Overnight watch',
          scan: 'Somebody stays with the setup' },
        { id: 'gate',     label: 'Gate and invitation checking' },
  ...
  'Anchor & MC': [
    ...
    },
    {
      ...
      choices: [
        ...
        { id: 'launch',     label: 'Product launches and openings' },
        { id: 'birthday',   label: 'Birthdays and anniversaries' },
        { id: 'kids',       label: 'Kids parties' },
        { id: 'college',    label: 'College and school events' },
        { id: 'religious',  label: 'Religious functions' },
      ],
    },
    {
      /* A wedding anchor, a corporate compere and a kids entertainer are
         three different performances, and the list above cannot separate
         them: plenty of people tick all ten. This is what a family is
         actually choosing between. */
      id: 'style',
      question: 'How do you host?',
      type: 'multi',
      choices: [
        { id: 'traditional', label: 'Traditional and formal',
          scan: 'Rituals announced properly, in order' },
        { id: 'bilingual',   label: 'Bilingual', scan: 'Two languages, switching' },
        { id: 'comedy',      label: 'Comedy and light' },
        { id: 'games',       label: 'Games and audience participation' },
        { id: 'corporate',   label: 'Corporate and scripted' },
        { id: 'singing',     label: 'I sing as well' },
      ],
    },
  ],
  ...
  'Invitation & Printing': [
    {
      ...
      choices: [
        ...
        { id: 'envelope',label: 'Envelopes, inserts and assembly',
          scan: 'The part that takes the time' },
        { id: 'monogram',label: 'A wedding logo or monogram' },
        { id: 'thankyou',label: 'Thank-you cards' },
  ...
  'Guest Services': [
    {
      ...
      choices: [
        ...
        { id: 'reception',label: 'Registration and gift desk',
          scan: 'Somebody has to receive the covers' },
        { id: 'cloakroom',label: 'Cloakroom and luggage' },
        ...
        { id: 'supervisor', label: 'A supervisor who runs the floor' },
        { id: 'queue',    label: 'Queue and crowd management' },
  ...
  'Power & Cooling': [
    {
      ...
      type: 'multi',
      choices: [
        { id: '15kva',  label: 'Up to 15 kVA', scan: 'A house function' },
        { id: '30kva',  label: 'Up to 30 kVA' },
        { id: '62kva',  label: '62 kVA' },
        { id: '125kva', label: '125 kVA' },
        { id: '250kva', label: '250 kVA or more', scan: 'Full production' },
        { id: 'silent', label: 'Silent canopy', scan: 'Quiet enough beside a mandap' },
        { id: 'ups',    label: 'UPS for the sound and lights',
          scan: 'So a changeover does not cut the music' },
        { id: 'fuel',   label: 'Fuel included in the rate' },
        { id: 'operator', label: 'An operator stays with the set' },
      ],
    },
    {
      id: 'cooling',
  ...
  'Safety & Facilities': [
    {
      ...
      choices: [
        ...
        { id: 'handwash',  label: 'Hand-wash and water stations' },
        { id: 'first_aid', label: 'First-aid attendant' },
        { id: 'ambulance', label: 'Ambulance on standby' },
        { id: 'fire',      label: 'Fire extinguishers' },
        { id: 'firemarshal',  label: 'A trained fire marshal on site' },
        { id: 'barriers',  label: 'Crowd barriers and cones' },
        { id: 'ramp',      label: 'Ramps and step-free access' },
        { id: 'waste',     label: 'Waste bins and clearing' },
      ],
    },
    {
      id: 'medical_grade',
